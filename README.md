...
> [!WARNING]
> **This is a WORK PC. Do not install here.** Copy the whole `SafeNet-Family` folder to your **home** PC and run it there.
...
You told me **everyone on the PC has Administrator rights** and you want to block **everyone, including yourself**. Be aware:
